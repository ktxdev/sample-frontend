  ...
  if (uploadState === 'idle') {
    return (
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Generate Quiz from PDF</h1>
          <p className="text-gray-600 dark:text-gray-400">Upload a PDF document and our AI will create a comprehensive quiz for you</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
              >
        ...
        <Card className="p-8">
          <div {...getRootProps()} className={`border-2 border-dashed rounded-lg p-12 text-center cursor-pointer transition-colors ${
            isDragActive ? 'border-indigo-400 bg-indigo-50 dark:bg-indigo-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-indigo-400 dark:hover:border-indigo-500'
          }`}>
            <input {...getInputProps()} />
        ...
        <Card className="p-8 text-center">
          <div className="mb-6">
            {uploadState === 'uploading' && (
              <>
                <Upload className="w-12 h-12 text-indigo-600 dark:text-indigo-400 mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Uploading File</h3>
                <p className="text-gray-600 dark:text-gray-400">Please wait while we upload your PDF...</p>
              </>
            )}
            {uploadState === 'processing' && (
              <>
                <div className="relative mb-4">
                  <div className="w-12 h-12 bg-indigo-100 dark:bg-indigo-900/50 rounded-full flex items-center justify-center mx-auto">
                    <Loader className="w-6 h-6 text-indigo-600 dark:text-indigo-400 animate-spin" />
                  </div>
                </div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Generating Quiz</h3>
                <p className="text-gray-600 dark:text-gray-400">Our AI is analyzing your PDF and creating {quizSettings.numberOfQuestions} {quizSettings.difficulty} questions...</p>
              </>
            )}
          </div>
          
          {uploadedFile && (
            <div className="flex items-center justify-center space-x-3 text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
    ...
    <div className="max-w-4xl mx-auto">
      <Card className="p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Quiz Generated Successfully!</h2>
          <p className="text-gray-600 dark:text-gray-400">Your quiz has been created and is ready to use</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-xl p-6 mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">{quiz.title}</h3>
            ...
            <div className="text-right">
              <div className="flex items-center space-x-4 text-sm text-gray-600 dark:text-gray-400">
                ...
                <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                  quiz.difficulty === 'easy' ? 'bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-300' :
                  quiz.difficulty === 'medium' ? 'bg-yellow-100 dark:bg-yellow-900/50 text-yellow-700 dark:text-yellow-300' :
          ...
          <div className="space-y-3">
            <h4 className="font-medium text-gray-900 dark:text-gray-100">Sample Questions:</h4>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <button className="flex items-center space-x-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
