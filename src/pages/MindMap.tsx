      ...
      <div className="flex-1 flex">
                  ...
                  {isEditing === node.id ? (
                    ...
                    >
                      <input
                        ...
                        className="w-full text-xs text-center bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded px-1 text-gray-900 dark:text-gray-100"
                        autoFocus
                      />
                    </foreignObject>
                  ) : (
        ...
        <Card className="w-64 p-4 ml-4">
          ...
          {selectedNode ? (
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Select a node to edit its properties</p>
          )}
        </Card>
      </div>
    </div>
